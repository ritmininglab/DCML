...
def load_imagenet_images(data_dir,noise_type):
    """
    ...
    if noise_type=='asy':
        train_classes = [os.path.join(data_dir, 'train-asy', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-asy')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-asy', family)))]
    elif noise_type == 'sym':
        train_classes = [os.path.join(data_dir, 'train-sym', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-sym')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-sym', family)))]
    elif noise_type == 'sym-10':
        train_classes = [os.path.join(data_dir, 'train-sym-10', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-sym-10')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-sym-10', family)))]
    elif noise_type == 'sym-20':
        train_classes = [os.path.join(data_dir, 'train-sym-20', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-sym-20')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-sym-20', family)))] 
    elif noise_type == 'sym-30':
        train_classes = [os.path.join(data_dir, 'train-sym-30', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-sym-30')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-sym-30', family)))]  
    elif noise_type == 'sym-40':
        train_classes = [os.path.join(data_dir, 'train-sym-40', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-sym-40')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-sym-40', family)))]
    elif noise_type == 'sym-50':
        train_classes = [os.path.join(data_dir, 'train-sym-50', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-sym-50')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-sym-50', family)))]                     
    elif noise_type=='bgm':
        train_classes = [os.path.join(data_dir, 'train-bgm', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-bgm')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-bgm', family)))]
    elif noise_type=='mix':
        train_classes = [os.path.join(data_dir, 'train-mix', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-mix')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-mix', family)))]
    elif noise_type=='mix-30':
        train_classes = [os.path.join(data_dir, 'train-mix-30', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-mix-30')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-mix-30', family)))]
    elif noise_type=='mix-40':
        train_classes = [os.path.join(data_dir, 'train-mix-40', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-mix-40')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-mix-40', family)))] 
    elif noise_type=='mix-50':
        train_classes = [os.path.join(data_dir, 'train-mix-50', family) \
                         for family in os.listdir(os.path.join(data_dir, 'train-mix-50')) \
                         if os.path.isdir((os.path.join(data_dir, 'train-mix-50', family)))]                         
    else:
...
class Task(object):
    ...
    def __init__(self, character_folders, num_classes, support_num, query_num):
        ...
        # for x in self.test_roots:
        #     labels[self.get_class(self.test_roots[1])]
...
class FC100Task(Task):
    """
    Class for defining a single few-shot task given ImageNet dataset.
    """

    def __init__(self, *args, **kwargs):
        super(FC100Task, self).__init__(*args, **kwargs)
